...
{
    /*
    A script that facilitates a moving platform for movement related puzzles and level
    progression.
    The platfrom moves in the same way as the flying enemy, moving between waypoints in a loop.
    The platfom movement speed and waypoint array can be changed in the Unity inspector.
   */
    ...
    // Start is called before the first frame update. Move to the next waypoint
    private void Start()
    {
